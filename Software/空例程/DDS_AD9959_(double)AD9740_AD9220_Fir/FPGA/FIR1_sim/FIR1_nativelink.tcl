...
if {[file exists FIR1_coef_reload.txt]} {
  set_global_assignment -name EDA_TEST_BENCH_FILE FIR1_coef_reload.txt -section_id tb -library work
}
if {[file exists FIR1_coef_reload_rtl.txt]} {
  set_global_assignment -name EDA_TEST_BENCH_FILE FIR1_coef_reload_rtl.txt -section_id tb -library work
}
set_global_assignment -name EDA_TEST_BENCH_FILE FIR1_input.txt -section_id tb -library work

set_global_assignment -name EDA_TEST_BENCH_FILE FIR1_tb.vhd -section_id tb -library work
