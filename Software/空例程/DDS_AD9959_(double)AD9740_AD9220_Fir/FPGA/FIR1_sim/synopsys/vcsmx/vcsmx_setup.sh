...
# ACDS 14.1 186 win32 2026.07.29.16:05:57
...
TOP_LEVEL_NAME="FIR1"
QSYS_SIMDIR="./../../"
QUARTUS_INSTALL_DIR="D:/app/altera/14.1/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  vhdlan -xlrm "$QSYS_SIMDIR/FIR1_rtl.vhd"                                   
  vhdlan -xlrm "$QSYS_SIMDIR/FIR1_ast.vhd"                                   
  vhdlan -xlrm "$QSYS_SIMDIR/FIR1.vhd"                                       
  vhdlan -xlrm "$QSYS_SIMDIR/FIR1_tb.vhd"                                    
fi
