...
set core_version 14.1
set device_family CYCLONEIVE
set quartus_rootdir D:/app/altera/14.1/quartus/
...
if {[string match $flow "rtl"] } {
    ...
    if {[file exists FIR1.vhd]} {vcom -93 -work work FIR1.vhd}
    if {[file exists FIR1.v]} {vlog -work work FIR1.v}
    vcom -93 -work work FIR1_ast.vhd
    vcom -93 -work work FIR1_rtl.vhd
