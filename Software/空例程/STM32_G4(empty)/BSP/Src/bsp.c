...
uint32_t ADC1_Data[ADC_DataSize],ADC2_Data[ADC_DataSize];
...
void MainProcess(void)
{
	...
	BSP_UART_Transmit_DMA(&UART_Debug, "G474VET6 UART1 Connected.\n");
	DDS_Init();
	while (1)
	{
...
void Delay(uint32_t t)//170MHz主频下延时1ms
{
...
void Delay_short(uint32_t t)//170MHz主频下延时1us
{
